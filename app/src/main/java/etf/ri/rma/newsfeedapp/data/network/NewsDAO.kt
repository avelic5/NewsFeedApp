...
class NewsDAO(private val service: TheNewsAPIService) {
    ...
    suspend fun getAllStories(): List<NewsItem> {
        if (!initialLoaded) {
            initMutex.withLock {//da se sprijeci da vise korutina pokusa dohvatiti inicijalne vijesti
                if (!initialLoaded) {
    ...
    /*{
        ...
        {
            "uuid": "a8ed26a2-12de-47a8-818a-dacb0757bc9e",
            "title": "No. 1 Aryna Sabalenka cruises...",
            "snippet": "World No. 1 Aryna Sabalenka...",
            "image_url": "https://a3.espncdn.com/...",
            "published_at": "2025-05-25T16:08:29.000000Z",
            "source": "espn.com",
            "categories": ["sports", "general"],
            "url": "https://www.espn.com/article-link",
            "keywords": "",
